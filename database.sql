-- PixelClip Database Schema
-- Run this SQL to set up your MySQL/MariaDB database

CREATE DATABASE IF NOT EXISTS pixelclip CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE pixelclip;
